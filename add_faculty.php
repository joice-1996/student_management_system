...
<?php
	$empidErr=$fnameErr=$mnameErr= $lnameErr=$desigErr=$emailErr=$passwordErr=$subjectErr="";
	$emp_id=$fname=$mname=$lname=$desig=$email=$password=$subject="";
...
<body class="bi">
	...
	<form  class="reg" method="post" action="">
		...
		<a href="admin_home.php" style="color:blue;text-decoration:none;border:1px solid blue">Back To Home</a>
		<table>
			<tr>
				<th>Employee ID:</th>
